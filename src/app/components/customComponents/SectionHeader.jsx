...
export default function SectionHeader({ name }) {
  return (
    <div className="relative py-10 w-full flex items-center">
      {/* Background Line */}
      {/* Light: Zinc-300 (Visible on white) | Dark: Zinc-800 */}
      <div className="absolute top-1/2 left-0 w-full border-t border-zinc-300 dark:border-zinc-800/50 -z-10 transition-colors duration-300"></div>
      ...
      <div
        ...
        /* Light Mode: White box with Grey Border */
      ...
      >
        ...
        {/* Text */}
        <span className="text-xl font-medium tracking-wider font-1boldonse uppercase transition-colors duration-300 text-zinc-00 dark:text-zinc-200">
          {name}
        </span>
      </div>
    </div>
