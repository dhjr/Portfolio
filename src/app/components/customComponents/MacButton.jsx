const Button = ({ text }) => {
  return (
    <button
      className="my-2 group relative w-auto cursor-pointer overflow-hidden rounded-full 
    ...
    >
      ...
      <div
        className="absolute top-0 z-10 flex h-full w-full translate-x-12 items-center justify-center gap-3 
